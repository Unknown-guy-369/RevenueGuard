...
worker:
	uv run celery -A revenueguard_worker.celery_app:celery_app worker --beat --queues=celery,event_dispatch,event_ingestion,action_dispatch,action_execution,action_reconciliation --loglevel=INFO
