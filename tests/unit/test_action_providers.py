...
async def test_razorpay_test_link_preserves_only_the_provider_short_url() -> None:
    transport = FakeTransport(
        HttpResponse(
            status_code=200,
            body=b'{"id":"plink_test_001","short_url":"https://rzp.io/i/test-payment"}',
    ...
    assert result.provider_object_id == "plink_test_001"
